    ...
    (function generatePlayerUI(playerData) {
        ...
        Object.keys(playerData).forEach(lang => {
            ...
            $(".langclass").append(
                ...
                '<img src="https://cdn.jsdelivr.net/gh/CJPlantillasStudios/plantillascj/servers/' + langIcon + '">' +
                '</li>'
            );
            ...
            playerData[lang].forEach(item => {
                ...
                $(".OD_" + lang).append(
                    ...
                    '<img src="https://cdn.jsdelivr.net/gh/CJPlantillasStudios/plantillascj/servers/' + cyberlockerIcon + '">' +
